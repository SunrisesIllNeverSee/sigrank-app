/**
 * app/vs/notch-pilot/page.tsx — "SigRank vs notch-pilot" SEO comparison page.
 *
...
// Comparison rows — feature-by-feature, notch-pilot vs SigRank.
const COMPARE_ROWS: { feature: string; notchpilot: string; sigrank: string }[] = [
  {
    feature: "What it is",
    notchpilot: "AI coding copilot / assistant",
    sigrank: "AI operator scoring + ranking platform",
  },
  {
    feature: "What it measures",
    notchpilot: "Nothing — it assists, doesn't measure",
  ...
  { feature: "Global operator leaderboard", notchpilot: "No", sigrank: "Yes" },
  {
...
const FAQS: { question: string; answer: string }[] = [
  {
    question: "Is SigRank a notch-pilot alternative?",
    answer:
  ...
  {
    question: "Why would I need SigRank if I already use notch-pilot?",
    answer:
  ...
  {
    question: "What does notch-pilot not measure that SigRank does?",
    answer:
  ...
  {
    question: "Can I use both notch-pilot and SigRank?",
    answer:
...
export default function VsNotchPilotPage() {
  return (
    <div className="mx-auto flex max-w-4xl flex-col gap-8 py-2">
      <JsonLd
        data={[
          breadcrumb([
            ...
            { name: "SigRank vs notch-pilot", path: "/vs/notch-pilot" },
          ]),
          faqPage(FAQS),
          comparisonArticle({
      ...
      <WaveHero
        eyebrow="\u25C8 SigRank vs notch-pilot"
        title="The Copilot Isn't the Pilot. The Score Is."
        subtitle={
          <>
      ...
      <section className="flex flex-col gap-4">
        ...
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
          notch-pilot is an AI coding assistant — a copilot that helps you write
          code faster. It does its job well: it suggests, completes, and
          generates. But it tells you nothing about <em>how efficiently you&apos;re
          ...
          other operators driving the same or different tools? notch-pilot
          can&apos;t answer any of those questions.
        </p>
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
          SigRank reads the token telemetry your copilot generates and scores
          the operator behind it. The headline metric,{" "}
          <strong className="text-text-primary">Υ Yield = cache_read ×
          output / input²</strong>, measures whether your cascade is compounding
          or burning. notch-pilot is the plane; SigRank is the lap timer. Both
          matter. Only one tells you whether you&apos;re winning.
        </p>
      </section>
      ...
      <section className="flex flex-col gap-4">
        ...
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
          notch-pilot answers <em>&quot;can it write code?&quot;</em> Yes. But
          that&apos;s the wrong question for anyone who wants to know whether
          they&apos;re getting better at driving AI. Two operators can use the
          same copilot and get wildly different outcomes. One reuses cached
          context efficiently and produces 30K output tokens; the other re-sends
          the same context every turn and produces 3K. Same tool, ten-fold
          difference in signal. notch-pilot can&apos;t see that gap.
        </p>
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
          ...
          without leverage. notch-pilot gives you the copilot; SigRank tells you
          whether the cascade it produces is{" "}
      ...
      <section className="flex flex-col gap-4">
        ...
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
          If you already use notch-pilot, you&apos;re generating the telemetry
          SigRank needs. Add the scoring layer the copilot can&apos;t provide:
        </p>
        <div className="rounded-lg border border-bg-border bg-bg-surface p-5">
...
sigrank submit      # reads logs, scores, signs, publishes`}
      ...
      <section className="flex flex-col gap-3 rounded-lg border border-bg-border bg-bg-surface p-6">
        ...
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
          Keep your copilot. Add the scorecard that turns your sessions into a
