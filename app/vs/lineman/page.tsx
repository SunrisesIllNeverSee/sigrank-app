/**
 * app/vs/lineman/page.tsx — "SigRank vs lineman" SEO comparison page.
 *
 * Angle: lineman tracks Claude Code spend — how much you're spending. SigRank
 * scores yield — how efficiently you're producing. Spend tracking is accounting;
 * yield scoring is evaluation.
 *
...
const COMPARE_ROWS: { feature: string; lineman: string; sigrank: string }[] = [
  {
    feature: "What it tracks",
    lineman: "Claude Code spend (dollars spent)",
  ...
  { feature: "Global operator leaderboard", lineman: "No", sigrank: "Yes" },
  {
...
const FAQS: { question: string; answer: string }[] = [
  {
    question: "Is SigRank a lineman alternative?",
    answer:
  ...
  {
    question: "Why is spend tracking not enough?",
    answer:
  ...
  {
    question: "What does lineman not measure that SigRank does?",
    answer:
  ...
  {
    question: "Can I use both lineman and SigRank?",
    answer:
...
export default function VsLinemanPage() {
  return (
    <div className="mx-auto flex max-w-4xl flex-col gap-8 py-2">
      <JsonLd
        data={[
          breadcrumb([
            ...
            { name: "SigRank vs lineman", path: "/vs/lineman" },
          ]),
          faqPage(FAQS),
          comparisonArticle({
            title: "SigRank vs lineman \u2014 Spend Tracking vs Yield Scoring",
            description: "lineman tracks Claude Code spend. SigRank scores yield. Spend tracking is accounting; yield scoring is evaluation. Cost is the input; yield is the output.",
            path: "/vs/lineman",
          }),
        ]}
      />
      ...
      <WaveHero
        eyebrow="\u25C8 SigRank vs lineman"
        title="Spend Is the Input. Yield Is the Output."
        subtitle={
          <>
            lineman tracks how much you spend on Claude Code. SigRank scores
            <span className="text-gold"> how efficiently you produce</span>.
            Spend tracking is accounting; yield scoring is evaluation.
          </>
        }
      />
      ...
      <section className="flex flex-col gap-4">
        ...
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
          lineman is a Claude Code spend tracker. It reads your token logs and
          shows how much you&apos;re spending — dollars burned, cost per session,
          spend over time. It does its job well: it <em>accounts for the
          spend</em>. But spend is the input, not the output. Two operators can
          spend the same $50 and get wildly different results. lineman
        ...
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
          ...
          penalizes the one who burns fresh input without leverage. lineman
      ...
      {/* Why spend isn't yield */}
      <section className="flex flex-col gap-4">
        <h2 className="font-mono text-base font-bold text-text-primary">
          Why spend tracking isn&apos;t yield scoring
        </h2>
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
          lineman answers <em>&quot;how much did I spend?&quot;</em> That&apos;s
          accounting, not evaluation. Two operators can spend the same $50 and
          ...
          every turn and produces 3K. Same spend, ten-fold difference in signal.
          On a spend tracker, they look identical. On a yield leaderboard, the
          gap is obvious.
        </p>
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
          ...
          without leverage. lineman gives you the bill; SigRank tells you whether
          the cascade it funded is <em>compounding or burning</em>.
        </p>
      ...
      <section className="flex flex-col gap-4">
        ...
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
          If you already run lineman, you have the token counts. SigRank reads
          the same telemetry and adds the scoring layer spend tracking never had:
        </p>
        <div className="rounded-lg border border-bg-border bg-bg-surface p-5">
...
sigrank submit      # reads logs, scores, signs, publishes`}
      ...
      <section className="flex flex-col gap-3 rounded-lg border border-bg-border bg-bg-surface p-6">
        ...
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
          Keep your spend tracker for the budget. Add the efficiency layer that
          spend tracking cannot provide. Install SigRank and submit your first
