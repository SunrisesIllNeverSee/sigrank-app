...
const COMPARE_ROWS: { feature: string; copilot: string; sigrank: string }[] = [
  {
    feature: "What it is",
    copilot: "AI pair programmer (inline + chat)",
    sigrank: "Platform-neutral operator scoring layer",
  },
  {
    feature: "Token usage tracking",
    copilot: "Limited (subscription-scoped)",
    sigrank: "Yes (four-pillar cascade)",
  },
  {
  ...
  {
    feature: "Works across Copilot + Cursor + Claude Code + 15+",
    copilot: "No (Copilot only)",
    sigrank: "Yes",
  },
  ...
  {
    feature: "Privacy-preserving (token counts only, no content)",
    copilot: "Yes",
    sigrank: "Yes",
  },
];
    ...
    <div className="mx-auto flex max-w-4xl flex-col gap-8 py-2">
      ...
      <section className="flex flex-col gap-4">
        ...
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
          GitHub Copilot is an AI pair programmer — inline completions, chat,
          and now agentic features inside VS Code, JetBrains, and GitHub.com. It
          is good at its job: helping you write code faster. What it does not do
          is tell you how <em>efficiently</em> you are driving it.
          Copilot&apos;s metrics are quota-scoped (are you near your limit?) not
      ...
      <section className="flex flex-col gap-4">
        ...
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
          ...
          don&apos;t have to. The natural question — &quot;how much did I help
          it write well?&quot; — is exactly the one Copilot doesn&apos;t answer.
          Two developers can accept the same number of Copilot completions and
          have wildly different cascade efficiency. One feeds Copilot tight,
          reusable context (high cache_read, low fresh input, high output); the
          other pastes a wall of stale context every turn (low cache_read, high
          input, low output). Same completions accepted. Ten-fold difference in
          Υ.
        </p>
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
          SigRank&apos;s{" "}
      ...
      <section className="flex flex-col gap-4">
        ...
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
          SigRank is platform-neutral by design. It does not compete with
          Copilot — it <em>measures</em> Copilot usage alongside every other AI
          tool you drive. Your Copilot sessions, your Claude Code sessions, your
          Cursor sessions: all scored on the same cascade axis, all feeding one
      ...
      <section className="flex flex-col gap-3 rounded-lg border border-bg-border bg-bg-surface p-6">
        ...
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
          ...
          the CLI, submit a signed snapshot, and see your Υ Yield and global
          rank.
        </p>
