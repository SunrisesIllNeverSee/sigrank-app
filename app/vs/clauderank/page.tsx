/**
 * app/vs/clauderank/page.tsx — "SigRank vs clauderank" SEO comparison page.
 *
 * Angle: clauderank ranks Claude Code users. SigRank ranks AI operators across
 * every platform. One tool is not the whole field.
 *
...
export const metadata: Metadata = withOG({
  title: "SigRank vs clauderank",
  description:
    "clauderank ranks Claude Code users. SigRank ranks AI operators across every platform. One tool is not the whole field. Cascade yield is platform-neutral.",
  path: "/vs/clauderank",
});

const COMPARE_ROWS: { feature: string; clauderank: string; sigrank: string }[] = [
  {
    feature: "What it ranks",
    clauderank: "Claude Code users",
    sigrank: "AI operators across every platform",
  },
  {
    feature: "Platform coverage",
    clauderank: "Claude Code only",
  ...
  },
  {
    ...
    clauderank: "Partial (rank profiles)",
    sigrank: "Yes",
  },
  {
...
const FAQS: { question: string; answer: string }[] = [
  {
    question: "Is SigRank a clauderank alternative?",
    answer:
  ...
  {
    question: "Why is Claude Code-only ranking not enough?",
    answer:
  ...
  {
    question: "What does clauderank not measure that SigRank does?",
    answer:
  ...
  {
    question: "Can I use both clauderank and SigRank?",
    answer:
  ...
  {
    question: "Which is better for finding the best AI operator?",
    answer:
...
export default function VsClauderankPage() {
  return (
    <div className="mx-auto flex max-w-4xl flex-col gap-8 py-2">
      <JsonLd
        data={[
          breadcrumb([
            ...
            { name: "SigRank vs clauderank", path: "/vs/clauderank" },
          ]),
          faqPage(FAQS),
          comparisonArticle({
            title: "SigRank vs clauderank \u2014 Claude Code Ranking vs Operator Ranking",
            description: "clauderank ranks Claude Code users. SigRank ranks AI operators across every platform. One tool is not the whole field. Cascade yield is platform-neutral.",
            path: "/vs/clauderank",
          }),
        ]}
      />
      ...
      <WaveHero
        eyebrow="\u25C8 SigRank vs clauderank"
        title="One Tool Isn't the Whole Field."
        subtitle={
          <>
            clauderank ranks Claude Code users. SigRank ranks AI operators
            across <span className="text-gold">every platform</span>. One tool
            is not the whole field.
          </>
        }
      />
      ...
      <section className="flex flex-col gap-4">
        ...
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
          clauderank is a ranking tool for Claude Code users. It ranks users by
          their Claude Code usage. It does its job: it <em>ranks the Claude
          Code crowd</em>. But most operators don&apos;t use just one tool. They
          drive Claude Code for some tasks, Cursor for others, Copilot for
          others. A Claude Code-only ranking misses everyone who isn&apos;t on
          Claude Code and can&apos;t compare operators across platforms.
        </p>
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
          ...
          drove. clauderank ranks the Claude Code crowd; SigRank ranks the whole
          field.
        </p>
      </section>
      ...
      <section className="flex flex-col gap-4">
        ...
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
          clauderank answers <em>&quot;who ranks highest on Claude Code?&quot;</em>
          ...
          Claude Code-only ranking can&apos;t compare an operator who uses
        ...
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
          ...
          clauderank ranks the Claude Code crowd; SigRank ranks the whole field.
        </p>
      ...
      <section className="flex flex-col gap-4">
        ...
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
          If you already run clauderank, you have the Claude Code ranking. SigRank
          reads the same telemetry and adds the cross-platform scoring layer
          Claude Code-only rankings never had:
        </p>
        <div className="rounded-lg border border-bg-border bg-bg-surface p-5">
...
sigrank submit      # reads logs, scores, signs, publishes`}
      ...
      <section className="flex flex-col gap-3 rounded-lg border border-bg-border bg-bg-surface p-6">
        ...
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
          Keep your Claude Code ranking for the clauderank crowd. Add the
          cross-platform operator ranking that Claude Code-only rankings cannot
