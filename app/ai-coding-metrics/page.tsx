    ...
    <div className="mx-auto flex max-w-3xl flex-col gap-8 py-2">
      ...
      <section className="flex flex-col gap-3">
        ...
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
          ...
          is the synthesis; the other five are the diagnostic views that explain
          why your yield is what it is.
        </p>
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
          Read them together. A high yield with a low cache hit rate means you
          are efficient despite poor cache reuse — probably because your output
          is very high relative to input. A high yield with a high cache hit
          rate means you are compounding: reusing cached context to amplify a
          small fresh input into large output. The latter is the sustainable
          pattern. The metrics tell you which one you are.
        </p>
      </section>
      ...
      <section className="flex flex-col gap-3">
        ...
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
          <strong className="text-text-primary">Yield</strong> is the composite.
          It multiplies cache reuse (cache_read) by output and divides by the
          square of input. That means yield rises when you reuse cache, when you
          produce more output, and when you send less fresh input — all at once.
          It is the one number that rewards the full compounding architecture.
        </p>
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
          <strong className="text-text-primary">Compression ratio</strong> is
          the output-over-input slice of yield — it ignores cache entirely. It
          tells you whether the model is doing more with your input than echoing
          it, but it cannot see whether you are compounding.
          <strong className="text-text-primary">
            {" "}
            Cache hit rate
          </strong> and <strong className="text-text-primary">
            leverage
          </strong>{" "}
          are the cache slices — they tell you how well you reuse context but
          say nothing about output.{" "}
          <strong className="text-text-primary">SNR</strong> is the quality lens
          on output. <strong className="text-text-primary">Velocity</strong> is
          the time lens — orthogonal to efficiency, useful for throughput
      ...
      <section className="flex flex-col gap-3">
        ...
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
          ...
          relative to input, check cache hit rate to see if you are failing to
          reuse context, check leverage to see if your cached foundation is too
          small. SNR tells you whether the output you do produce is dense with
          signal. Velocity is a secondary metric — track it for throughput, but
          do not optimize for it at the expense of yield.
        </p>
      </section>
      ...
      <section className="flex flex-col gap-4">
        ...
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
          ...
          >
            ...
            <p className="mt-1.5 font-sans text-sm leading-relaxed text-text-secondary">
              The canonical methodology page: how the metrics are computed, how
        ...
        <dl className="flex flex-col gap-4">
          <div className="flex flex-col gap-1">
            ...
            <dd className="font-sans text-sm leading-relaxed text-text-secondary">
              Six metrics derived from four token pillars: yield, compression
              ratio, signal-to-noise ratio, cache hit rate, leverage, and
              velocity. Each measures a different facet of the token cascade —
              the flow of tokens through an AI coding session.
            </dd>
          </div>
          <div className="flex flex-col gap-1">
            <dt className="font-semibold text-text-primary">
            ...
            <dd className="font-sans text-sm leading-relaxed text-text-secondary">
              ...
              rate as diagnostic lenses to understand why your yield is what it
              is.
            </dd>
          </div>
          <div className="flex flex-col gap-1">
            ...
            <dd className="font-sans text-sm leading-relaxed text-text-secondary">
              ...
              output-over-input slice. Cache hit rate and leverage are the cache
              slices. SNR is the quality lens. Velocity is the time lens. Yield
              is the synthesis; the rest are diagnostics.
            </dd>
          </div>
          <div className="flex flex-col gap-1">
            <dt className="font-semibold text-text-primary">
            ...
            <dd className="font-sans text-sm leading-relaxed text-text-secondary">
              ...
              Yield is token-cascade efficiency — how well you compound signal.
              A fast operator burning tokens can have high velocity but low
              yield. SigRank ranks by yield, not velocity.
            </dd>
          </div>
          <div className="flex flex-col gap-1">
            <dt className="font-semibold text-text-primary">
