    ...
    <div className="mx-auto flex max-w-3xl flex-col gap-8 py-2">
      ...
      <section className="flex flex-col gap-3">
        ...
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
          ...
          input into dense output. The unit of measurement is the token, and the
          architecture of the cascade is the score.
        </p>
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
          It is a new performance layer because it sits between two existing
          layers that each miss half the picture. Model benchmarks rank the AI
          but ignore the operator. Time trackers rank the operator but measure
          the wrong currency — hours, not tokens. Operator scoring ranks the
          operator in the currency that actually matters for LLM compute:
      ...
      <section className="flex flex-col gap-3">
        ...
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
          Model benchmarking asks <em>which AI is best?</em> and ranks models by
          test-suite scores (MMLU, HumanEval, SWE-bench) or preference votes
          (LMSYS Chatbot Arena). It holds the operator as a constant — the same
          harness, the same prompts, the same evaluators — and varies the model.
        ...
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
          ...
          you chose well. Most developers have never had the second measurement.
          That is the gap SigRank fills.
        </p>
      </section>
      ...
      <section className="flex flex-col gap-3">
        ...
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
          Time trackers — WakaTime and its peers — measure hours spent coding.
          They reward presence: the more time you log, the more productive you
          appear. But time is a proxy for productivity, not a measure of it. A
          developer who compounds signal in two hours outscores one who burns
          tokens for eight — but the time tracker ranks them in the opposite
          order. Operator scoring measures the actual currency of LLM compute:
          tokens. It rewards the architecture of the cascade, not the duration
          of the session.
        </p>
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
          This matters more as AI coding becomes the dominant mode of
          development. When the bottleneck is not how fast you type but how well
          you drive an AI, hours become a misleading metric. Token efficiency is
          the number that tracks the skill that actually matters.
        </p>
      </section>
      ...
      <section className="flex flex-col gap-3">
        ...
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
          ...
          Cursor, and 15+ platforms. The foundation is a published conservation
          law for language under compression (DOI: 10.5281/zenodo.20029607).
        </p>
      </section>
      ...
      <section className="flex flex-col gap-3">
        ...
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
          Operator scoring is privacy-preserving by construction. The on-device
          scanner reads token counts only — four integers per session. It never
          reads the content of your prompts or the model&apos;s responses. Only
          ed25519-signed numeric scores leave your device. Server-side
          verification operates on integers with replay and plausibility guards,
          never on text. Your prompts, your code, and your conversation history
          never leave your machine.
        </p>
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
          This is what makes a global, continuous operator leaderboard possible.
          You cannot publish a ranking built on prompt content without a privacy
          scandal. You can publish one built on four signed integers. Token
          counts are the unit that makes operator scoring safe enough to run at
          scale.
        </p>
      </section>
        ...
        <dl className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1">
            ...
            <dd className="font-sans text-sm leading-relaxed text-text-secondary">
              ...
              &ldquo;which AI is best?&rdquo; Operator scoring ranks humans by
          ...
          <div className="flex flex-col gap-1">
            ...
            <dd className="font-sans text-sm leading-relaxed text-text-secondary">
              ...
              it rewards the architecture of how you use the AI. A developer who
              compounds signal in two hours outscores one who burns tokens for
              eight.
            </dd>
          </div>
          <div className="flex flex-col gap-1">
