...
const STATIC_ROUTES: { path: string; priority: number; changeFrequency: MetadataRoute.Sitemap[number]['changeFrequency'] }[] = [
  ...
  { path: '/alternatives/ai-coding-metrics', priority: 0.7, changeFrequency: 'monthly' },
  { path: '/alternatives/ccusage-alternatives', priority: 0.7, changeFrequency: 'monthly' },
  { path: '/alternatives/ai-benchmarking-tools', priority: 0.7, changeFrequency: 'monthly' },
  { path: '/alternatives/token-tracking-tools', priority: 0.7, changeFrequency: 'monthly' },

  // Guide pages — educational intent
  { path: '/guides/how-to-measure-ai-coding-efficiency', priority: 0.6, changeFrequency: 'monthly' },
  { path: '/guides/how-to-track-token-cascade', priority: 0.6, changeFrequency: 'monthly' },
  { path: '/guides/how-to-improve-your-yield', priority: 0.6, changeFrequency: 'monthly' },
  { path: '/guides/how-to-benchmark-ai-coding-workflow', priority: 0.6, changeFrequency: 'monthly' },
  { path: '/guides/how-to-reduce-token-waste', priority: 0.6, changeFrequency: 'monthly' },
  { path: '/guides/how-to-compare-ai-operators', priority: 0.6, changeFrequency: 'monthly' },
  { path: '/guides/how-to-read-your-cascade', priority: 0.6, changeFrequency: 'monthly' },

  // Metric definition pages — definitional intent
  { path: '/metrics/yield-cascade', priority: 0.6, changeFrequency: 'monthly' },
  { path: '/metrics/compression-ratio', priority: 0.6, changeFrequency: 'monthly' },
  { path: '/metrics/signal-to-noise-ratio', priority: 0.6, changeFrequency: 'monthly' },
  { path: '/metrics/cache-hit-rate', priority: 0.6, changeFrequency: 'monthly' },
  ...
  { path: '/tools/yield-calculator', priority: 0.7, changeFrequency: 'monthly' },
  { path: '/tools/cascade-comparator', priority: 0.7, changeFrequency: 'monthly' },
  { path: '/tools/operator-class-checker', priority: 0.7, changeFrequency: 'monthly' },
  { path: '/tools/token-waste-calculator', priority: 0.7, changeFrequency: 'monthly' },
  ...
  { path: '/blog/best-ai-coding-tools-2026', priority: 0.6, changeFrequency: 'monthly' },
  { path: '/blog/how-to-benchmark-ai-coding-workflow', priority: 0.6, changeFrequency: 'monthly' },
]
