...
const STATIC_ROUTES: {
  ...
  { path: "/field/snr-separation", priority: 0.7, changeFrequency: "weekly" },
  { path: "/field/leverage-velocity", priority: 0.7, changeFrequency: "weekly" },
  { path: "/field/platform-dominance", priority: 0.7, changeFrequency: "weekly" },
  { path: "/field/cascade-composition", priority: 0.7, changeFrequency: "weekly" },
  { path: "/field/yield-quartiles", priority: 0.7, changeFrequency: "weekly" },
  { path: "/field/eighty-percent", priority: 0.7, changeFrequency: "weekly" },
  { path: "/field/where-are-you", priority: 0.7, changeFrequency: "weekly" },
  { path: "/field/ghost-ranks", priority: 0.7, changeFrequency: "weekly" },
  { path: "/field/build-archetypes", priority: 0.7, changeFrequency: "weekly" },
  { path: "/field/outlier-detection", priority: 0.7, changeFrequency: "weekly" },
