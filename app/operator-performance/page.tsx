    ...
    <div className="mx-auto flex max-w-3xl flex-col gap-8 py-2">
      ...
      <section className="flex flex-col gap-3">
        ...
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
          ...
          The other walks away with a cascade that burns: high input, low cache
          reuse, thin output. Same model. Same clock. Wildly different results.
        </p>
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
          The difference is not the model. The difference is the operator — how
          they structure their prompts, how they reuse context, how they manage
          the cascade across turns. The model is a constant. The operator is the
          variable. SigRank is built to measure that variable.
        </p>
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
      ...
      <section className="flex flex-col gap-3">
        ...
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
          ...
          per session: input, output, cache-read, cache-write. From those four
          integers, the yield metric{" "}
      ...
      <section className="flex flex-col gap-4">
        ...
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
          ...
          Tiers run from low to high — they describe where an operator is in the
          compounding journey, not a fixed label.
        </p>
      ...
      <section className="flex flex-col gap-3">
        ...
        <dl className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1">
            ...
            <dd className="font-sans text-sm leading-relaxed text-text-secondary">
              From four on-device token counts. Yield (Υ = cache_read × output /
              input²) is the headline. The composite SIGNA rate blends yield
              with signal-force and drift. Weights (RS.xx) are server-side.
              Snapshots are ed25519-signed and verified.
            </dd>
          </div>
          <div className="flex flex-col gap-1">
            <dt className="font-semibold text-text-primary">
            ...
            <dd className="font-sans text-sm leading-relaxed text-text-secondary">
              ...
              prompts, code, and conversation history never leave your machine.
            </dd>
          </div>
        </dl>
      </section>
