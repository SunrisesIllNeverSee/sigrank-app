    ...
    <div className="mx-auto flex max-w-3xl flex-col gap-8 py-2">
      ...
      <WaveHero
        ...
        subtitle={
          <>
            ...
            <span className="text-gold">compounds</span> and which one burns —
            across yield, compression, cache hit rate, and leverage.
          </>
        }
      />
      ...
      <section className="flex flex-col gap-3">
        ...
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
          Each row flags the cascade with the edge.{" "}
          <strong className="text-text-primary">Υ Yield</strong> is the headline
          — it folds cache reuse and output density into one number, so a
          cascade can win on raw output yet lose on yield if it re-sends fresh
          context every turn.{" "}
          <strong className="text-text-primary">Cache hit rate</strong> and{" "}
          <strong className="text-text-primary">leverage</strong> reveal whether
          the edge comes from reusing context or from denser output. Read them
          together: a high-yield cascade with low leverage is output-dense but
          cache-poor; a high-yield cascade with high leverage is the compounding
          ideal.
        </p>
      </section>
