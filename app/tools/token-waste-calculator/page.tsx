  ...
  return (
    <div className="mx-auto flex max-w-3xl flex-col gap-8 py-2">
      ...
      <WaveHero
        ...
        subtitle={
          <>
            How many of your tokens actually contributed to output? Enter your
            pillars for waste analysis and see estimated{" "}
            <span className="text-gold">waste</span>, efficiency, and a
      ...
      <section className="flex flex-col gap-3">
        ...
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
          A token is &ldquo;wasted&rdquo; when it likely did not contribute to
          useful output. The three categories the calculator surfaces —{" "}
          <strong className="text-text-primary">excess fresh input</strong>{" "}
          (over-specified prompts),{" "}
          <strong className="text-text-primary">unreused cache writes</strong>{" "}
          (context cached but never read back), and{" "}
          <strong className="text-text-primary">repeated context</strong>{" "}
          (boilerplate re-sent every turn) — are the most common ways operators
          burn tokens without compounding signal.
        </p>
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
          This is a heuristic estimator. Token counts alone cannot see prompt
          content, so the category thresholds are approximations. Treat the
          numbers as a directional diagnostic, and pair them with the rigorous{" "}
          <a
