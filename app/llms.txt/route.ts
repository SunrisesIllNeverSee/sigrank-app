...
- [Field Analysis](${SITE_ORIGIN}/field?utm_source=ai&utm_medium=answer_engine): AI operator field distribution — the true distribution of token efficiency across 1,611 human operators. Volume ≠ Yield thesis, SNR separation, platform dominance, ghost ranks, bot detection.
