...
export default function CascadeAnalysisPage() {
  return (
    <div className="mx-auto flex max-w-3xl flex-col gap-8 py-2">
      <JsonLd
        data={[
          breadcrumb([{ name: "Cascade Analysis", path: "/cascade-analysis" }]),
          faqPage([
            {
            ...
            {
              question:
                "What is the difference between a compounding cascade and a burning cascade?",
              answer:
      ...
      <WaveHero
        ...
        subtitle={
          <>
            ...
            <span className="text-gold">cascade</span>. Learn to read the flow —
            and tell compounding signal from burning tokens.
          </>
        }
      />
      ...
      <section className="flex flex-col gap-3">
        ...
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
          ...
          trickles out. Cascade analysis is the art of reading which kind of
          cascade you have.
        </p>
      </section>
      ...
      <section className="flex flex-col gap-3">
        ...
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
          ...
          fresh input on top of a large cached foundation). A high output number
          is good only if it is dense — SNR tells you that. The yield metric Υ =
          cache_read × output / input² is the synthesis: it rewards high cache
          reuse and high output while punishing high fresh input. If your yield
          is low, the four pillars tell you why.
        </p>
      </section>
      ...
      <section className="flex flex-col gap-4">
        ...
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
          ...
          <div className="rounded-lg border border-bg-border bg-bg-surface p-5">
            ...
            <p className="mt-2 font-sans text-sm leading-relaxed text-text-secondary">
              How much context you are storing for future turns. An investment.
              It only pays off if you read it back — check cache-read.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="flex flex-col gap-4">
        ...
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
          The four pillars combine into recognizable shapes. Here are the four
          most common — and what each one tells you.
        </p>
      ...
      <section className="flex flex-col gap-3">
        ...
        <dl className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1">
            ...
            <dd className="font-sans text-sm leading-relaxed text-text-secondary">
              Read the four pillars together. High cache-read + low input + high
              output = compounding. High input + low cache-read + low output =
              burning. The diagnostic patterns on this page map the common
              shapes.
            </dd>
          </div>
          <div className="flex flex-col gap-1">
          ...
          <div className="flex flex-col gap-1">
            ...
            <dd className="font-sans text-sm leading-relaxed text-text-secondary">
              A compounding cascade has high cache-read, low input, high output.
              A burning cascade has high input, low cache-read, low output.
              Yield is high for the first, low for the second. The difference is
