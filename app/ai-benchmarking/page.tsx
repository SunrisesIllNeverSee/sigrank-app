  ...
  return (
    <div className="mx-auto flex max-w-3xl flex-col gap-8 py-2">
      <JsonLd
        data={[
          breadcrumb([
            { name: 'AI Benchmarking', path: '/ai-benchmarking' },
          ]),
          faqPage([
            {
            ...
            {
              question: 'What is the difference between operator benchmarking and model benchmarking?',
              answer:
      ...
      <section className="flex flex-col gap-3">
        ...
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
          ...
          question and the leaderboards answer it well. But it is only half
          the picture. The other half — <em>who is best at using the model
          they have?</em> — has no leaderboard. Model benchmarking holds the
          model as the variable and the operator as a constant. In practice
          the opposite is true: the model is a constant (you pick one and
          drive it), and the operator is the variable (two people on the same
          model produce wildly different results).
        </p>
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
          There is a second problem. Model benchmarks rely on synthetic test
          suites or human preference votes — not on real coding telemetry.
          A test suite tells you the model can solve a curated problem in a
          ...
          efficiently a real developer drives the model through a real
          coding session over a real week. That gap is where operator time,
          money, and signal are actually won or lost.
        </p>
      </section>
      ...
      <section className="flex flex-col gap-3">
        ...
        <div className="overflow-hidden rounded-lg border border-bg-border bg-bg-surface">
          <table className="w-full text-left font-sans text-sm">
            ...
            <tbody className="divide-y divide-bg-border-subtle">
              <tr>
                <td className="px-4 py-3 font-semibold text-text-primary">Question</td>
                <td className="px-4 py-3 text-text-secondary">Which AI is best?</td>
                <td className="px-4 py-3 text-text-secondary">Who uses the AI best?</td>
              </tr>
              <tr>
                <td className="px-4 py-3 font-semibold text-text-primary">Ranks</td>
                <td className="px-4 py-3 text-text-secondary">Models</td>
                <td className="px-4 py-3 text-text-secondary">Humans (operators)</td>
              </tr>
              <tr>
                <td className="px-4 py-3 font-semibold text-text-primary">Data</td>
                <td className="px-4 py-3 text-text-secondary">Test suites / preference votes</td>
                <td className="px-4 py-3 text-text-secondary">Real token telemetry</td>
              </tr>
              <tr>
                <td className="px-4 py-3 font-semibold text-text-primary">Setting</td>
                <td className="px-4 py-3 text-text-secondary">Controlled harness</td>
                <td className="px-4 py-3 text-text-secondary">Live coding sessions</td>
              </tr>
              <tr>
                <td className="px-4 py-3 font-semibold text-text-primary">Example</td>
                <td className="px-4 py-3 text-text-secondary">LMSYS Chatbot Arena</td>
        ...
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
          The two categories are complements, not competitors. A model
          benchmark helps you choose a model. An operator benchmark helps you
          measure whether you are driving the model you chose well. Most
          developers have never had the second one. That is the gap SigRank
          fills.
        </p>
      </section>
      ...
      <section className="flex flex-col gap-3">
        ...
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
          ...
          cascade. Four pillars — input, output, cache-read, cache-write —
          are captured on-device from real coding sessions across 15+
          platforms. The yield metric{' '}
        ...
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
          ...
          compression (DOI: 10.5281/zenodo.20029607), with an empirical
          record and a public transformation harness. The data is
          privacy-preserving — token counts only, never prompt content — and
          cryptographically signed. It is benchmarking built on real
          telemetry, real science, and real privacy, not on preference votes
          or synthetic tests.
        </p>
      </section>
        ...
        <dl className="flex flex-col gap-4">
          <div className="flex flex-col gap-1">
            ...
            <dd className="font-sans text-sm leading-relaxed text-text-secondary">
              ...
              introduces operator benchmarking — ranking the humans driving
              the AI by token-cascade efficiency.
            </dd>
          </div>
          <div className="flex flex-col gap-1">
            <dt className="font-semibold text-text-primary">
            ...
            <dd className="font-sans text-sm leading-relaxed text-text-secondary">
              It holds the model as the variable and the operator as a
              constant — the inverse of reality. It also relies on synthetic
              tests or preference votes, not real coding telemetry. It cannot
              see the operator-level difference that determines real-world
              efficiency.
            </dd>
          </div>
          <div className="flex flex-col gap-1">
            ...
            <dd className="font-sans text-sm leading-relaxed text-text-secondary">
              Model benchmarking asks &ldquo;which AI is best?&rdquo; and
              ranks models using test suites or votes. Operator benchmarking
              asks &ldquo;who is best at using the AI?&rdquo; and ranks humans
              using real token telemetry. They are complements, not
              competitors.
            </dd>
          </div>
          <div className="flex flex-col gap-1">
            ...
            <dd className="font-sans text-sm leading-relaxed text-text-secondary">
              ...
              architecture. Operators are ranked by yield, tiered, and scored
              over multiple time windows. Snapshots are ed25519-signed. No
