    ...
    <div className="mx-auto flex max-w-4xl flex-col gap-8 py-2">
      ...
      <section className="flex flex-col gap-4">
        ...
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
          AI benchmarking splits into two camps.{" "}
          <strong className="text-text-primary">Model benchmarking</strong> asks
          "which AI model is best?" — LMSYS, HELM, the Open LLM Leaderboard, and
          HumanEval all live here.{" "}
          <strong className="text-text-primary">Operator benchmarking</strong>{" "}
          asks "who uses AI most efficiently?" — and SigRank is the only tool in
          this camp. The distinction matters: the same model can produce a
          Burner or a 10×er depending on how the operator manages context. Model
          benchmarks tell you what to drive; operator benchmarks tell you how
          well you drive it.
        </p>
              ...
              {TOOLS.map((t) => (
                ...
                >
                  ...
                  <td className="p-3 font-sans text-xs text-text-secondary">
                    {t.featured ? (
                      <span className="text-gold">Yes (operators)</span>
                    ) : (
                      "Yes (models)"
                    )}
                  </td>
      ...
      <section className="flex flex-col gap-3 rounded-lg border border-gold/30 bg-gold/5 p-6">
        ...
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
          Model benchmarks and operator benchmarks answer different questions.
          Use LMSYS, HELM, the Open LLM Leaderboard, or HumanEval to decide{" "}
          <em>which model</em> to drive. Then use SigRank to measure{" "}
          <em>how well you drive it</em> — your Υ Yield, your class tier, and
          your rank against every other operator. The best stack is both: pick
          the best model, then operate it efficiently.
        </p>
        <p className="font-sans text-sm leading-relaxed text-text-muted">
