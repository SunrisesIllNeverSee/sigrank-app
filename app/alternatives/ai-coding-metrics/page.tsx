  ...
  return (
    <div className="mx-auto flex max-w-4xl flex-col gap-8 py-2">
      ...
      <WaveHero
        ...
        subtitle={
          <>
            Seven tools that measure AI-assisted coding, compared. Only one
            scores the <span className="text-gold">operator</span>, not the
            model.
          </>
        }
      />
      ...
      <section className="flex flex-col gap-4">
        ...
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
          AI coding assistants are now the default — but most developers have no
          idea whether their AI usage is <em>efficient</em>. Are you compounding
      ...
      <section className="flex flex-col gap-3 rounded-lg border border-gold/30 bg-gold/5 p-6">
        ...
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
          If you only want to <em>read</em> your token counts, ccusage is the
          simplest option. If you want to <em>track time</em>, WakaTime is
          mature. If you want to know which
          <em> model</em> is best, check LMSYS. But if you want to know how{" "}
          <strong className="text-text-primary">
            efficiently you operate AI
          </strong>{" "}
          — and where you rank against every other operator — SigRank is the
          only tool that scores the operator, not the model.
        </p>
        <p className="font-sans text-sm leading-relaxed text-text-muted">
