  ...
  return (
    <div className="mx-auto flex max-w-3xl flex-col gap-8 py-2">
      <JsonLd
        data={[
          ...
          faqPage([
            {
              question:
                "What does the token cascade tell me about my workflow?",
              answer:
      ...
      <WaveHero
        ...
        subtitle={
          <>
            Your cascade is a <span className="text-gold">diagnostic</span> — it
            tells you exactly what&rsquo;s working and what&rsquo;s broken in
            your AI coding workflow. Here&rsquo;s how to read it.
          </>
        }
      />
      ...
      <section className="flex flex-col gap-4">
        ...
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
          Your token cascade isn&rsquo;t just a score — it&rsquo;s a diagnostic
          tool. The four pillars are like blood panel results: each tells you
          something specific about your workflow&rsquo;s health. Read together,
          they tell you exactly what to fix. Run{" "}
      ...
      <section className="flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-3">
          <div className="rounded-lg border border-bg-border bg-bg-surface p-5">
            ...
            <p className="font-sans text-sm leading-relaxed text-text-secondary">
              Input reveals how much fresh context you inject per turn. High
              input means you&rsquo;re sending new context the model
              hasn&rsquo;t seen — either because your context window is unstable
              (cache breaks) or because you&rsquo;re re-pasting files
              unnecessarily. Low input means you&rsquo;re sending small deltas
              on top of a stable cached base.
            </p>
          </div>
          <div className="rounded-lg border border-bg-border bg-bg-surface p-5">
            <p className="font-mono text-sm font-bold text-gold">
            ...
            <p className="font-sans text-sm leading-relaxed text-text-secondary">
              Output reveals how much signal the model produces per turn. High
              output means your prompts generate useful code efficiently. Low
              output with high input means the model is churning or your prompts
              are unfocused.
            </p>
          </div>
          <div className="rounded-lg border border-bg-border bg-bg-surface p-5">
            ...
            <p className="font-sans text-sm leading-relaxed text-text-secondary">
              Cache-read reveals how well you reuse context via prompt caching —
              the most diagnostic pillar. High cache-read means your context
              window is stable and the model reads from cache. Low cache-read
              means your cache breaks every turn.
            </p>
          </div>
          <div className="rounded-lg border border-bg-border bg-bg-surface p-5">
            <p className="font-mono text-sm font-bold text-gold">
            ...
            <p className="font-sans text-sm leading-relaxed text-text-secondary">
              Cache-write reveals how much you&rsquo;re investing in future
              cache hits. High cache-write early that converts to cache-read
              later is a healthy, compounding cascade. High cache-write that
              never converts means your cache keeps breaking before it pays off.
            </p>
          </div>
        </div>
      </section>
        ...
        <ul className="flex flex-col gap-2">
          <li className="font-sans text-sm leading-relaxed text-text-secondary">
            ...
            <strong className="text-text-primary">
              context window is stable
            </strong>{" "}
            — you&rsquo;re not reordering context or changing the system prompt
            between turns.
          </li>
          <li className="font-sans text-sm leading-relaxed text-text-secondary">
            You&rsquo;re sending{" "}
            <strong className="text-text-primary">small deltas</strong> on top
            of a large cached base, not re-pasting full context.
          </li>
          <li className="font-sans text-sm leading-relaxed text-text-secondary">
            Your <strong className="text-text-primary">cache hit rate</strong>{" "}
            is high (above 80%) — you write to cache once and read from it many
            times.
          </li>
          <li className="font-sans text-sm leading-relaxed text-text-secondary">
            Your <strong className="text-text-primary">yield is high</strong> —
            cache-read is in the yield numerator, so high cache-read directly
            boosts Υ.
          </li>
        </ul>
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
          If your cache-read is high, keep doing what you&rsquo;re doing. The
          next lever is output — can you get even more signal per turn with
      ...
      <section className="flex flex-col gap-4">
        ...
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
          High input with low output is the most common dysfunction —
          you&rsquo;re sending a lot of fresh context but the model isn&rsquo;t
          producing much signal. The usual culprits:
        </p>
        <ul className="flex flex-col gap-2">
          <li className="font-sans text-sm leading-relaxed text-text-secondary">
            <strong className="text-text-primary">Verbose prompts</strong> —
            conversational padding, restated context, redundant instructions.
            The model processes 500 tokens to find the 20-token instruction
            buried inside.
          </li>
          <li className="font-sans text-sm leading-relaxed text-text-secondary">
            <strong className="text-text-primary">Unstable context</strong> —
            your cache breaks every turn, so the model re-processes everything
            as fresh input but produces the same output it would have from
            cache.
          </li>
          <li className="font-sans text-sm leading-relaxed text-text-secondary">
            <strong className="text-text-primary">Noisy context</strong> — your
            context window includes irrelevant files or instructions that dilute
            the signal. The model processes noise instead of signal.
          </li>
          <li className="font-sans text-sm leading-relaxed text-text-secondary">
            <strong className="text-text-primary">Re-rolls</strong> — you
            regenerate from scratch instead of correcting, sending fresh input
            without advancing cache-read.
          </li>
        </ul>
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
          The fix: structure inputs to be minimal, stabilize your context
          window, and replace re-rolls with corrections. Each fix reduces input
      ...
      <section className="flex flex-col gap-4">
        ...
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
          A balanced cascade isn&rsquo;t about equal pillar counts — it&rsquo;s
          about the right <em>ratios</em>. The ideal cascade shape:
        </p>
        <div className="rounded-lg border border-bg-border bg-bg-surface p-5">
          <ul className="flex flex-col gap-2">
            <li className="font-sans text-sm leading-relaxed text-text-secondary">
              <strong className="text-gold">High cache-read</strong> — the
              largest pillar. Most of your context is reused, not re-sent.
            </li>
            <li className="font-sans text-sm leading-relaxed text-text-secondary">
              <strong className="text-gold">Low input</strong> — the smallest
              pillar. You send only tiny deltas on top of cache.
            </li>
            <li className="font-sans text-sm leading-relaxed text-text-secondary">
              <strong className="text-gold">High output</strong> — the model
              generates substantial signal per turn.
            </li>
            <li className="font-sans text-sm leading-relaxed text-text-secondary">
              <strong className="text-gold">Moderate cache-write</strong> —
              early investment that converts to cache-read over time.
            </li>
          </ul>
        </div>
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
      ...
      <section className="flex flex-col gap-4">
        ...
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
          Your class tier summarizes your cascade shape into a single label — a
          quick diagnostic and a target:
        </p>
        <div className="flex flex-col gap-3">
          <div className="rounded-lg border border-bg-border bg-bg-surface p-5">
            <p className="font-mono text-sm font-bold text-gold">IGNITER</p>
            <p className="font-sans text-sm leading-relaxed text-text-secondary">
              Low yield. Mostly fresh input, little cache reuse. The cascade
              burns tokens, not compounds them. Focus: stabilize your context
              window.
            </p>
          </div>
          <div className="rounded-lg border border-bg-border bg-bg-surface p-5">
            ...
            <p className="font-sans text-sm leading-relaxed text-text-secondary">
              ...
              dominates. The cascade starts to compound but breaks frequently.
              Focus: maintain context stability.
            </p>
          </div>
          <div className="rounded-lg border border-bg-border bg-bg-surface p-5">
            ...
            <p className="font-sans text-sm leading-relaxed text-text-secondary">
              ...
              with better prompt structure and batched tasks.
            </p>
          </div>
          <div className="rounded-lg border border-bg-border bg-bg-surface p-5">
        ...
        <dl className="flex flex-col gap-4">
          <div className="flex flex-col gap-1">
            ...
            <dd className="font-sans text-sm leading-relaxed text-text-secondary">
              The four pillars reveal how you manage context, how efficiently
              you prompt, and whether signal is compounding or being burned.
              It&rsquo;s a diagnostic — each pillar points to a specific aspect
              of your workflow.
            </dd>
          </div>
          <div className="flex flex-col gap-1">
            ...
            <dd className="font-sans text-sm leading-relaxed text-text-secondary">
              Good context reuse. Your context window is stable and the model
              reads from cache instead of re-processing fresh input. This is the
              signature of an efficient operator and directly boosts yield.
            </dd>
          </div>
          <div className="flex flex-col gap-1">
            <dt className="font-semibold text-text-primary">
            ...
            <dd className="font-sans text-sm leading-relaxed text-text-secondary">
              Inefficient prompting. You&rsquo;re sending a lot but getting
              little back. Usually caused by verbose prompts, unstable context,
              noisy context, or re-rolls. Fix: structure inputs, stabilize
              context, replace re-rolls with corrections.
            </dd>
          </div>
          <div className="flex flex-col gap-1">
            <dt className="font-semibold text-text-primary">
            ...
            <dd className="font-sans text-sm leading-relaxed text-text-secondary">
              High cache-read (largest pillar), low input (smallest), high
              output, and moderate cache-write that converts to cache-read over
              time. Cache-read dominates, input is minimal, output is high.
            </dd>
          </div>
          <div className="flex flex-col gap-1">
            <dt className="font-semibold text-text-primary">
