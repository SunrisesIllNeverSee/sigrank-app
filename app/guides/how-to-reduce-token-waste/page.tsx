  ...
  return (
    <div className="mx-auto flex max-w-3xl flex-col gap-8 py-2">
      ...
      <WaveHero
        ...
        subtitle={
          <>
            Token waste is the silent killer of AI coding efficiency.
            Here&rsquo;s how to find it, fix it, and{" "}
            <span className="text-gold">measure the improvement</span>.
          </>
        }
      />
      ...
      <section className="flex flex-col gap-4">
        ...
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
          Token waste isn&rsquo;t about using too many tokens — it&rsquo;s about
          using the
          <em> wrong kind</em>. Fresh input is expensive (squared in the yield
          denominator); cache-read is cheap (in the numerator). Waste happens
          when you burn fresh input that could have been cache-read. The four
          most common sources:
        </p>
        <div className="flex flex-col gap-3">
          <div className="rounded-lg border border-bg-border bg-bg-surface p-5">
            ...
            <p className="font-sans text-sm leading-relaxed text-text-secondary">
              Re-sending files, system prompts, or project context the model
              already has. Every re-paste is fresh input that could have been
              cache-read. The #1 waste source — and the easiest to fix.
            </p>
          </div>
          <div className="rounded-lg border border-bg-border bg-bg-surface p-5">
            <p className="font-mono text-sm font-bold text-gold">
            ...
            <p className="font-sans text-sm leading-relaxed text-text-secondary">
              Unstable context windows that invalidate the cache between turns.
              If you reorder context, change the system prompt, or restructure
              your file list, the cache breaks and everything re-processes as
              fresh input.
            </p>
          </div>
          <div className="rounded-lg border border-bg-border bg-bg-surface p-5">
            ...
            <p className="font-sans text-sm leading-relaxed text-text-secondary">
              Conversational padding, restated context, and redundant
              instructions. A 500-token prompt that could be 50 tokens costs
              100× more in the yield denominator (input is squared). Brevity
              isn&rsquo;t just style — it&rsquo;s math.
            </p>
          </div>
          <div className="rounded-lg border border-bg-border bg-bg-surface p-5">
            <p className="font-mono text-sm font-bold text-gold">
            ...
            <p className="font-sans text-sm leading-relaxed text-text-secondary">
              Regenerating from scratch instead of correcting. Each re-roll
              sends fresh input and generates new output without advancing
              cache-read. Three re-rolls triples your input with zero cache
              benefit.
            </p>
          </div>
        </div>
      ...
      <section className="flex flex-col gap-4">
        ...
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
          ...
          and examine your four pillars. Each waste source leaves a specific
          fingerprint:
        </p>
        <ul className="flex flex-col gap-3">
          <li className="rounded-lg border border-bg-border bg-bg-surface p-5">
            ...
            <p className="font-sans text-sm leading-relaxed text-text-secondary">
              You&rsquo;re re-sending context the model already has. Your cache
              hit rate will be low (below 50%). Fix: stabilize your context
              window.
            </p>
          </li>
          <li className="rounded-lg border border-bg-border bg-bg-surface p-5">
            ...
            <p className="font-sans text-sm leading-relaxed text-text-secondary">
              Cache hit rate = cache_read / (cache_read + cache_write). Below
              50% means your cache is churning. Fix: keep context stable across
              turns.
            </p>
          </li>
          <li className="rounded-lg border border-bg-border bg-bg-surface p-5">
            ...
            <p className="font-sans text-sm leading-relaxed text-text-secondary">
              You&rsquo;re sending a lot but getting little back. Your
              compression ratio (output / input) will be low. Fix: structure
              inputs to be minimal.
            </p>
          </li>
          <li className="rounded-lg border border-bg-border bg-bg-surface p-5">
            <p className="font-mono text-sm font-bold text-text-primary">
            ...
            <p className="font-sans text-sm leading-relaxed text-text-secondary">
              You&rsquo;re generating a lot of output but not reusing context.
              Multiple re-rolls produce high output but low signal density. Fix:
              replace re-rolls with corrections.
            </p>
          </li>
        </ul>
      </section>
      ...
      <section className="flex flex-col gap-4">
        ...
        <div className="rounded-lg border border-bg-border bg-bg-surface p-5">
          ...
          <ol className="mt-2 flex flex-col gap-1.5">
            <li className="font-sans text-sm leading-relaxed text-text-secondary">
              1. Front-load stable context (project rules, file contents) in
              turn 1.
            </li>
            <li className="font-sans text-sm leading-relaxed text-text-secondary">
            ...
            <li className="font-sans text-sm leading-relaxed text-text-secondary">
              3. Send only the delta — changed lines, new instructions — on top
              of cache.
            </li>
            <li className="font-sans text-sm leading-relaxed text-text-secondary">
        ...
        <div className="rounded-lg border border-bg-border bg-bg-surface p-5">
          ...
          <ol className="mt-2 flex flex-col gap-1.5">
            <li className="font-sans text-sm leading-relaxed text-text-secondary">
              1. Don&rsquo;t reorder context between turns — position matters
              for cache.
            </li>
            <li className="font-sans text-sm leading-relaxed text-text-secondary">
            ...
            <li className="font-sans text-sm leading-relaxed text-text-secondary">
              3. Ensure your context exceeds the cache threshold (typically
              1,024+ tokens).
            </li>
            <li className="font-sans text-sm leading-relaxed text-text-secondary">
        ...
        <div className="rounded-lg border border-bg-border bg-bg-surface p-5">
          ...
          <ol className="mt-2 flex flex-col gap-1.5">
            <li className="font-sans text-sm leading-relaxed text-text-secondary">
              1. Remove conversational padding (&ldquo;Hey, so I was
              wondering...&rdquo;).
            </li>
            <li className="font-sans text-sm leading-relaxed text-text-secondary">
        ...
        <div className="rounded-lg border border-bg-border bg-bg-surface p-5">
          ...
          <ol className="mt-2 flex flex-col gap-1.5">
            ...
            <li className="font-sans text-sm leading-relaxed text-text-secondary">
              2. If the response is wrong, correct with a small delta on top of
              cache.
            </li>
            <li className="font-sans text-sm leading-relaxed text-text-secondary">
              3. Reserve re-rolls for when the model is truly off-track, not for
              minor adjustments.
            </li>
            <li className="font-sans text-sm leading-relaxed text-text-secondary">
      ...
      <section className="flex flex-col gap-4">
        ...
        <ul className="flex flex-col gap-2">
          <li className="font-sans text-sm leading-relaxed text-text-secondary">
            <strong className="text-text-primary">Υ Yield</strong> should rise —
            less input and more cache-read both push it up.
          </li>
          <li className="font-sans text-sm leading-relaxed text-text-secondary">
            <strong className="text-text-primary">Cache hit rate</strong> should
            climb toward 80%+ as your context stabilizes.
          </li>
          <li className="font-sans text-sm leading-relaxed text-text-secondary">
            <strong className="text-text-primary">Input count</strong> should
            drop — fewer fresh tokens, more cache reuse.
          </li>
          <li className="font-sans text-sm leading-relaxed text-text-secondary">
            <strong className="text-text-primary">Compression ratio</strong>{" "}
            should rise — more output per input token.
          </li>
        </ul>
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
        ...
        <dl className="flex flex-col gap-4">
          <div className="flex flex-col gap-1">
            ...
            <dd className="font-sans text-sm leading-relaxed text-text-secondary">
              Repeated context, poor prompt caching, verbose prompts, and
              unnecessary re-rolls. Each wastes fresh input tokens, which are
              squared in the yield denominator.
            </dd>
          </div>
          <div className="flex flex-col gap-1">
            <dt className="font-semibold text-text-primary">
            ...
            <dd className="font-sans text-sm leading-relaxed text-text-secondary">
              Run `sigrank me` and examine your pillars. High input + low
              cache-read = repeated context. Low cache hit rate = poor caching.
              High input + low output = verbose prompts. High input + high
              output + low cache-read = re-rolls.
            </dd>
          </div>
          <div className="flex flex-col gap-1">
            <dt className="font-semibold text-text-primary">
            ...
            <dd className="font-sans text-sm leading-relaxed text-text-secondary">
              Build a stable context window. Send only deltas on top of cached
              context. Use file references instead of re-pasting contents.
            </dd>
          </div>
          <div className="flex flex-col gap-1">
            <dt className="font-semibold text-text-primary">
            ...
            <dd className="font-sans text-sm leading-relaxed text-text-secondary">
              Compare yield before and after. Reducing input and increasing
              cache-read both raise yield. Track cache hit rate and input count
          ...
          <div className="flex flex-col gap-1">
            ...
            <dd className="font-sans text-sm leading-relaxed text-text-secondary">
              Yes. Fresh input tokens are the most expensive. Cache-read tokens
              are significantly cheaper. Converting fresh input into cache-read
              reduces both spend and yield penalty.
            </dd>
          </div>
        </dl>
      </section>
