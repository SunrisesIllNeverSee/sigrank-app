    ...
    <div className="mx-auto flex max-w-3xl flex-col gap-8 py-2">
      ...
      <section className="flex flex-col gap-4">
        ...
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
          When people talk about &ldquo;AI coding performance,&rdquo; they
          usually mean model performance. LMSYS Chatbot Arena ranks models by
          human preference. But model benchmarks tell you which AI is best — not
          who drives it best. Two operators using the exact same model, the
          exact same platform, can have yields that differ by orders of
          magnitude. The difference isn&rsquo;t the model. It&rsquo;s the{" "}
          <strong className="text-text-primary">operator</strong>.
        </p>
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
          An operator with a stable context window, minimal prompts, and
          deliberate cache reuse will outperform an operator who re-pastes files
          every turn — regardless of whether they&rsquo;re on Claude, GPT, or
          Gemini. The cascade architecture is a function of the operator&rsquo;s
          workflow, not the model&rsquo;s capabilities.
        </p>
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
          That&rsquo;s why SigRank ranks operators, not models. When you compare
          operators, you&rsquo;re comparing workflows — and workflows are what
          you can actually change. You can&rsquo;t upgrade the model, but you
          can restructure your context window today.
        </p>
      </section>
      ...
      <section className="flex flex-col gap-4">
        ...
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
          ...
          renders a side-by-side cascade comparison of two or more operators.
          You enter codenames from the leaderboard and get a full breakdown:
          yield, cache hit rate, leverage, compression ratio, class tier, and
          the four-pillar ratios. It shows you not just <em>who</em> is more
          efficient but <em>why</em>.
        </p>
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
          The compare tool is platform-neutral — you can compare a Claude Code
          operator against a Cursor operator, because the four pillars are the
          same across all platforms. The comparison is about the
          operator&rsquo;s cascade architecture, not the tool they happen to
          use.
        </p>
      </section>
      ...
      <section className="flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-3">
          <div className="rounded-lg border border-bg-border bg-bg-surface p-5">
            ...
            <p className="font-sans text-sm leading-relaxed text-text-secondary">
              The headline. Overall cascade efficiency. Start here — it tells
              you who is more efficient. Then dig into the other metrics to
              understand why.
            </p>
          </div>
          <div className="rounded-lg border border-bg-border bg-bg-surface p-5">
            ...
            <p className="font-sans text-sm leading-relaxed text-text-secondary">
              cache_read / (cache_read + cache_write). How well each operator
              reuses context. A higher hit rate means better context stability.
              This is the metric that most directly reflects context window
              management.
            </p>
          </div>
          <div className="rounded-lg border border-bg-border bg-bg-surface p-5">
            ...
            <p className="font-sans text-sm leading-relaxed text-text-secondary">
              cache_read / input. How much cached context amplifies fresh input.
              High leverage means the operator sends small deltas on a large
              cached base — the hallmark of an efficient workflow.
            </p>
          </div>
          <div className="rounded-lg border border-bg-border bg-bg-surface p-5">
            <p className="font-mono text-sm font-bold text-gold">
            ...
            <p className="font-sans text-sm leading-relaxed text-text-secondary">
              output / input. How much signal each operator gets per fresh input
              token. High compression means concise, high-signal prompting. Low
              compression means verbose prompts or wasted input.
            </p>
          </div>
          <div className="rounded-lg border border-bg-border bg-bg-surface p-5">
      ...
      <section className="flex flex-col gap-4">
        ...
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
          Start with yield — it&rsquo;s the headline. If one operator has a
          yield of 50,000 and the other has 5,000, there&rsquo;s a 10× gap. But
          yield alone doesn&rsquo;t tell you what to change. Dig into the
          four-pillar ratios:
        </p>
        <ul className="flex flex-col gap-3">
          <li className="rounded-lg border border-bg-border bg-bg-surface p-5">
            ...
            <p className="font-sans text-sm leading-relaxed text-text-secondary">
              The operator has a stable context window and sends small deltas.
              This is the most common yield driver. To close the gap: stabilize
              your context and stop re-pasting.
            </p>
          </li>
          <li className="rounded-lg border border-bg-border bg-bg-surface p-5">
            <p className="font-mono text-sm font-bold text-text-primary">
            ...
            <p className="font-sans text-sm leading-relaxed text-text-secondary">
              The operator gets more signal per turn — better prompt structure,
              more focused tasks. To close the gap: structure your inputs and
              batch related tasks.
            </p>
          </li>
          <li className="rounded-lg border border-bg-border bg-bg-surface p-5">
            ...
            <p className="font-sans text-sm leading-relaxed text-text-secondary">
              The operator&rsquo;s cached context amplifies their fresh input
              more. They&rsquo;ve built a large cached base and send tiny deltas
              on top. To close the gap: invest in cache-write early, then
      ...
      <section className="flex flex-col gap-4">
        ...
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
          ...
          benchmarking is finding operators one tier above you and studying
          their cascade.
        </p>
        <ol className="flex flex-col gap-4">
          ...
          <li className="flex flex-col gap-2 rounded-lg border border-bg-border bg-bg-surface p-5">
            ...
            <p className="font-sans text-sm leading-relaxed text-text-secondary">
              Use the compare tool to put yourself side-by-side with an operator
              one tier above. Look at the metric where the gap is largest —
              that&rsquo;s your highest-leverage improvement area.
            </p>
          </li>
          <li className="flex flex-col gap-2 rounded-lg border border-bg-border bg-bg-surface p-5">
            <p className="font-mono text-sm font-bold text-gold">
            ...
            <p className="font-sans text-sm leading-relaxed text-text-secondary">
              Apply the workflow change that addresses the gap. If their cache
              hit rate is higher, focus on context stability. If their
              compression ratio is higher, focus on prompt structure. Re-measure
              after a week.
            </p>
          </li>
          <li className="flex flex-col gap-2 rounded-lg border border-bg-border bg-bg-surface p-5">
            ...
            <p className="font-sans text-sm leading-relaxed text-text-secondary">
              Once you close one gap, find the next operator above you and
              repeat. Benchmarking is iterative — each comparison reveals the
              next improvement.
            </p>
          </li>
        </ol>
      ...
      <section className="flex flex-col gap-3">
        ...
        <dl className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1">
            ...
            <dd className="font-sans text-sm leading-relaxed text-text-secondary">
              The /compare tool renders a side-by-side cascade comparison of
              operators — yield, cache hit rate, leverage, compression ratio,
              class tier, and four-pillar ratios. Platform-neutral: compare
              across Claude, Cursor, Copilot, and more.
            </dd>
          </div>
          <div className="flex flex-col gap-1">
            <dt className="font-semibold text-text-primary">
            ...
            <dd className="font-sans text-sm leading-relaxed text-text-secondary">
              Yield (overall efficiency), cache hit rate (context reuse),
              leverage (cache amplification), compression ratio (output per
              input), and class tier (performance band). Each reveals a
          ...
          <div className="flex flex-col gap-1">
            ...
            <dd className="font-sans text-sm leading-relaxed text-text-secondary">
              Start with yield, then dig into the four-pillar ratios. Higher
              cache-read + lower input = better context reuse. Higher output +
              similar input = better prompting. The ratios tell you what to
              change.
            </dd>
          </div>
          <div className="flex flex-col gap-1">
            ...
            <dd className="font-sans text-sm leading-relaxed text-text-secondary">
              Submit to the leaderboard, check your rank and tier, then use the
              compare tool against operators one tier above you. Study their
              cascade, close the gap, and repeat.
            </dd>
          </div>
        </dl>
      </section>
