...
export default function TokenTelemetryPage() {
  return (
    <div className="mx-auto flex max-w-3xl flex-col gap-8 py-2">
      <JsonLd
        data={[
          breadcrumb([{ name: "Token Telemetry", path: "/token-telemetry" }]),
          faqPage([
            {
      ...
      <WaveHero
        ...
        subtitle={
          <>
            ...
            <span className="text-gold">token cascade</span> — without reading a
            single word of your prompts.
          </>
        }
      />
      ...
      <section className="flex flex-col gap-3">
        ...
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
          ...
          counts, never the content. Four integers — input, output, cache_read,
          cache_write — fully describe the architecture of a token cascade. They
          tell you whether signal is compounding (high cache reuse, high output
          per fresh input) or tokens are burning (low cache, low output). You do
          not need a single word of the prompt or the response to know that.
        </p>
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
          This is what makes token telemetry privacy-preserving by construction.
          The scanner reads counts and content lengths locally. Only the
          resulting numeric scores, signed with ed25519, leave your device.
          Server-side verification operates on integers — replay guards,
          plausibility checks — never on text. Your prompts, your code, your
          conversation history never leave your machine.
        </p>
        <p className="font-sans text-sm leading-relaxed text-text-secondary">
          The tradeoff is deliberate: you give up the ability to analyze what
          someone said to their AI, and in exchange you get a measurement system
        ...
        <dl className="flex flex-col gap-4">
          <div className="flex flex-col gap-1">
            ...
            <dd className="font-sans text-sm leading-relaxed text-text-secondary">
              The on-device measurement of AI coding activity through four token
              counts — input, output, cache-read, and cache-write. It records
              how many tokens flowed through your sessions without ever reading
              the content of your prompts or the model&apos;s responses.
            </dd>
          </div>
          <div className="flex flex-col gap-1">
            <dt className="font-semibold text-text-primary">
          ...
          <div className="flex flex-col gap-1">
            ...
            <dd className="font-sans text-sm leading-relaxed text-text-secondary">
              ...
              scores leave your device, and server-side verification operates on
              integers, not text.
            </dd>
          </div>
        </dl>
