...
test("the guard only catches the LAZIEST fabrication (literal zero creation)", () => {
  const lazy = {
    tokens_cache_read: 5_000_000_000,
    tokens_cache_creation: 0,
    tokens_input_fresh: 1_000,
    tokens_output: 10_000_000,
  };
  assert.equal(
    contaminationFlagged(lazy),
    true,
    "zero-creation is the only shape it reliably stops",
  );
});
