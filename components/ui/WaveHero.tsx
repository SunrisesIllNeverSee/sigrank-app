...
const WAVES = [
  {
    d: "M0,46 C120,18 240,74 360,46 C480,18 600,74 720,46 C840,18 960,74 1080,46 C1140,32 1170,40 1200,46",
    stroke: "rgb(var(--gold))",
    opacity: 0.55,
    dur: "7s",
    delay: "0s",
  ...
  {
    d: "M0,52 C140,80 280,24 420,52 C560,80 700,24 840,52 C980,80 1120,24 1200,52",
  ...
  {
    d: "M0,40 C100,30 220,58 340,40 C460,22 580,58 700,40 C820,22 940,58 1060,40 C1120,31 1160,36 1200,40",
    stroke: "rgb(var(--class-seeker))",
    opacity: 0.3,
    dur: "11s",
    delay: "-4s",
    width: 1.5,
