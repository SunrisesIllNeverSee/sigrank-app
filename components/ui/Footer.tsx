...
// ITEM 3 (owner 2026-06-22): footer nav cleared — "clear out the nav in the footer, I'm going to
// redo it later." Brand + the legal/privacy line below are kept; links return on the footer redesign.
  ...
  return (
    <footer className="mt-16 w-full border-t border-bg-border bg-bg-surface">
      <div className="mx-auto flex max-w-6xl flex-col gap-4 px-4 py-8">
        ...
        <div className="flex flex-col gap-1.5 border-t border-bg-border pt-4 sm:flex-row sm:items-center sm:justify-between">
