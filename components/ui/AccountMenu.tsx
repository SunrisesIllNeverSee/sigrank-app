...
export function AccountMenu() {
  ...
  const displayName = operator ? operator.displayName || operator.codename : null
      ...
      >
        {operator ? (
          <>
            ...
            <span className="max-w-[10rem] truncate text-text-primary">{displayName}</span>
          </>
        ) : (
          <>
      ...
      {open &&
        ...
        createPortal(
          ...
          >
            {operator ? (
              <>
                <Link href="/me" role="menuitem" onClick={() => setOpen(false)} className={itemCls}>
                  My Profile
                </Link>
                <Link
                  href="/settings"
              ...
              <>
                ...
                <Link href="/login" role="menuitem" onClick={() => setOpen(false)} className={itemCls}>
