...
const ROW_COPY: Record<string, LadderRow> = {
  "K.01": {
    id: "K.01",
    desc: "You don't just use the system. You are the system. Sustained high-yield cascade across all dimensions.",
    range: "SNR ≥ 0.85",
  },
  "K.02": {
    id: "K.02",
    desc: "Precision creators. Structure from signal. Others follow your patterns.",
    range: "0.75 – 0.84",
  },
  "K.03": {
    id: "K.03",
    desc: "System builders. Coherent operators with consistent output.",
    range: "0.65 – 0.74",
  },
  "K.04": {
    id: "K.04",
    desc: "Forming forge. High activity, signal still emerging from noise.",
    range: "0.50 – 0.64",
  },
  "K.05": {
    id: "K.05",
    desc: "Signal breaking through. Clarity emerging. Active development phase.",
    range: "0.40 – 0.49",
  },
  "K.06": {
    id: "K.06",
    desc: "Active explorers. High throughput, low reuse. Curiosity-driven.",
    range: "0.30 – 0.39",
  },
  "K.07": {
    id: "K.07",
    desc: "Practicing with purpose. Consistent mid-tier. Quiet build phase.",
    range: "0.20 – 0.29",
  },
  "K.08": {
    id: "K.08",
