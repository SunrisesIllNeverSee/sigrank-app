        ...
        {Array.from({ length: blocks }, (_, i) => (
          <span
            ...
            style={{
              ...
              marginRight: "1px",
              background:
                i < filled ? colors.class.REFINER : colors.bg.elevated,
      ...
      <div style={styles.section}>
        ...
        {stats.tokenBreakdown && (
          <div style={styles.tokenBreakdown}>
            Token breakdown:{" "}
            <span style={styles.tokenPart}>
              {formatTokens(stats.tokenBreakdown.input)} input
            </span>
            {" | "}
            <span style={styles.tokenPart}>
              {formatTokens(stats.tokenBreakdown.output)} output
            </span>
            {" | "}
            <span style={styles.tokenPart}>
              {formatTokens(stats.tokenBreakdown.thinking)} thinking
            </span>
            {" | "}
            <span style={styles.tokenPart}>
              {formatTokens(stats.tokenBreakdown.cache)} cache
            </span>
          </div>
        )}
