...
const SAMPLE_CLASSES: K2ClassEntry[] = [
  {
    ...
    trait: "Enhancing Signal",
    liveCount: 3,
    maxCount: 1645,
  },
  {
    signalClass: "ARCH+",
    trait: "Precision Creators",
    liveCount: 5,
    maxCount: 1645,
  },
  {
    signalClass: "ARCH",
    trait: "System Builders",
    liveCount: 3,
    maxCount: 1645,
  },
  {
  ...
  {
    signalClass: "BASE",
    trait: "Signal Breaking Thru",
    liveCount: 178,
    maxCount: 1645,
  },
  {
    signalClass: "SEEKER",
    trait: "Active Explorers",
    liveCount: 489,
    maxCount: 1645,
  },
  {
    signalClass: "REFINER",
    trait: "Practicing with Purpose",
    liveCount: 470,
    maxCount: 1645,
  },
  {
    signalClass: "BEARER",
    trait: "Quiet Insight Holders",
    liveCount: 643,
    maxCount: 1645,
  },
  {
    signalClass: "IGNITER",
    trait: "Dormant Potential",
    liveCount: 1645,
    maxCount: 1645,
  },
];
...
const CLASS_DEFS: Partial<Record<SignalClass, string>> = {
  ...
  SEEKER:
    "Curiosity is courage. Keep Asking. Clustering — High prompts, low S/N refinement.",
  REFINER:
    "Practicing with purpose. Every prompt shaping precision — Consistent mid tier",
  BEARER:
    "You've carried signal long enough. Speak again — the legends — Deep threads",
    ...
    <div style={styles.wrapper}>
      ...
      <div style={styles.tableWrapper}>
        <div style={styles.brandBar}>
          ...
          <span style={styles.brandBarRank}>
            ★ Rank #{rank} • {score}
          </span>
        </div>
        ...
        <table style={styles.table}>
          ...
          <tbody>
            {classes.map((entry) => {
              const color =
                colors.class[entry.signalClass] ?? colors.text.muted;
              return (
                <tr key={entry.signalClass} style={styles.row}>
                  ...
                  <td style={{ ...styles.td, textAlign: "right" }}>
                    <LiveCountBar
                      count={entry.liveCount}
                      max={entry.maxCount ?? 2000}
                    />
                  </td>
                </tr>
              );
      ...
      <div style={styles.section}>
        <div style={styles.sectionTitle}>
          ▸ CLASS DEFINITIONS + SIGNAL METRIC CRITERIA
        </div>
          ...
          {classes.map((entry) => {
            ...
            return (
              <div key={entry.signalClass} style={styles.defRow}>
                <span style={{ ...styles.defClass, color }}>
                  {entry.signalClass}
                </span>
      ...
      <div style={styles.footer}>
        <span style={styles.footerText}>
          Generated by TheSignalVault | SigRank | Timestamp: {timestamp}
        </span>
      </div>
    </div>
  );
