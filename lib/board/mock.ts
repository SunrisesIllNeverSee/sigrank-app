 ...
 *
 * TYPES extracted to lib/data/types.ts (2026-06-26) — this module now imports
 * them from there. The mock DATA (MOCK_LEADERBOARD etc.) stays here as the
 * cold-store fallback for local dev / no-creds.
 */

import type { SignalClass } from "@/components/sigrank/types";
import { CLASS_NAME_TO_ID } from "@/lib/identity/canon-ids";
import type {
  Operator,
  ScoredSnapshot,
  SupporterTier,
...
// Types re-exported from the neutral types module (was defined inline here).
export type {
  LeaderboardRow,
  TelemetryRaw,
  HistoryPoint,
...
const SEED_CORPUS: SeedSpec[] = [
  ...
  {
    codename: "TransVaultOrigin·tokscale",
    realHandle: "MO§ES (tokscale reader)",
    domain: "claude",
    supporter: "pro",
    verification: "audited",
    input: 61_349_259,
    output: 17_117_729,
    cacheCreate: 161_665_905,
    cacheRead: 3_570_556_236,
    signa: 96.4,
    comp: 0.218,
    pc: 92,
    ct: 37,
  ...
  {
    codename: "app seed",
    realHandle: "OWNER all-time (Claude desktop-app in/out + tokenpull cache)",
    domain: "claude",
    supporter: "pro",
    verification: "audited",
    input: 6_400_000,
    output: 38_700_000,
    cacheCreate: 151_089_792,
    cacheRead: 3_746_087_427,
    signa: 99.0,
    comp: 0.858,
    pc: 95,
    ct: 40,
  ...
  {
    codename: "OrcaVanguard",
    realHandle: "Ólafur Nils Sigurðsson",
    handle: "olafurns7",
    domain: "claude",
    supporter: "pro",
    verification: "verified",
    input: 20_500_000_000,
    output: 1_900_000_000,
    cacheCreate: 1_400_000_000,
    cacheRead: 572_400_000_000,
    signa: 88.0,
    comp: 0.88,
    pc: 84,
    ct: 36,
  ...
  {
    codename: "IronLattice",
    realHandle: "Ivan Golovach",
    handle: "IvGolovach",
    domain: "claude",
    supporter: "patron",
    verification: "verified",
    input: 17_000_000_000,
    output: 1_300_000_000,
    cacheCreate: 352_600,
    cacheRead: 512_000_000_000,
    signa: 84.0,
    comp: 0.84,
    pc: 80,
    ct: 33,
  ...
  {
    codename: "PrismCartographer",
    realHandle: "Feng GAO",
    handle: "gaofeng21cn",
    domain: "gemini",
    supporter: "free",
    verification: "unverified",
    input: 26_900_000_000,
    output: 2_000_000_000,
    cacheCreate: 238_300,
    cacheRead: 475_400_000_000,
    signa: 79.3,
    comp: 0.792,
    pc: 73,
    ct: 28,
  ...
  {
    codename: "MeridianScribe",
    realHandle: "Max Ghenis",
    handle: "MaxGhenis",
    domain: "claude",
    supporter: "patron",
    verification: "verified",
    input: 16_200_000_000,
    output: 1_100_000_000,
    cacheCreate: 1_100_000_000,
    cacheRead: 361_400_000_000,
    signa: 76.1,
    comp: 0.764,
    pc: 70,
    ct: 26,
  ...
  {
    codename: "VectorHerald",
    realHandle: "Sylvain Tissier",
    handle: "SylTi",
    domain: "multi",
    supporter: "circle_sponsor",
    verification: "audited",
    input: 8_300_000_000,
    output: 495_200_000,
    cacheCreate: 111_400_000,
    cacheRead: 210_600_000_000,
    signa: 71.0,
    comp: 0.701,
    pc: 66,
    ct: 24,
  ...
  {
    codename: "EmberCoil",
    realHandle: "Maple Gao",
    handle: "MapleEve",
    domain: "pi",
    supporter: "free",
    verification: "unverified",
    input: 36_900_000_000,
    output: 3_000_000_000,
    cacheCreate: 1_000_000_000,
    cacheRead: 824_400_000_000,
    signa: 57.8,
    comp: 0.561,
    pc: 53,
    ct: 18,
  ...
  {
    codename: "DriftPilgrim",
    realHandle: "Vincent Koc",
    handle: "vincentkoc",
    domain: "gemini",
    supporter: "patron",
    verification: "verified",
    input: 7_400_000_000,
    output: 415_100_000,
    cacheCreate: 223_700_000,
    cacheRead: 233_400_000_000,
    signa: 47.2,
    comp: 0.452,
    pc: 44,
    ct: 14,
  ...
  {
    codename: "SignalFledgling",
    realHandle: "ben",
    handle: "cexll",
    domain: "claude",
    supporter: "free",
    verification: "unverified",
    input: 67_700_000_000,
    output: 64_000_000_000,
    cacheCreate: 168_800_000,
    cacheRead: 36_800_000_000,
    signa: 36.5,
    comp: 0.354,
    pc: 33,
    ct: 10,
  ...
  {
    codename: "QuietHollow",
    realHandle: "steve wu",
    handle: "wuwangzhang1216",
    domain: "pi",
    supporter: "free",
    verification: "unverified",
    input: 164_100_000_000,
    output: 26_000_000_000,
    cacheCreate: 170_100_000,
    cacheRead: 296_800_000_000,
    signa: 24.0,
    comp: 0.224,
    pc: 21,
    ct: 6,
  ...
  {
    codename: "AshIgnition",
    realHandle: "Nepomuk Crhonek",
    handle: "Nepomuk5665",
    domain: "chatgpt",
    supporter: "free",
    verification: "unverified",
    input: 4_036_000_000_000,
    output: 1_258_000_000_000,
    cacheCreate: 99_000_000_000,
    cacheRead: 1_661_000_000_000,
    signa: 11.8,
    comp: 0.118,
    pc: 12,
    ct: 3,
  ...
  {
    codename: "static seed · 7d ✱mem",
    realHandle: "OWNER 7d (WITH claude-mem — inflated)",
    domain: "claude",
    supporter: "free",
    verification: "unverified",
    input: 3_404_076,
    output: 5_561_147,
    cacheCreate: 67_871_602,
    cacheRead: 1_163_017_207,
    signa: 56.0,
    comp: 0.62,
    pc: 60,
    ct: 20,
  ...
  {
    codename: "static seed · 30d ✱mem",
    realHandle: "OWNER 30d (WITH claude-mem — inflated)",
    domain: "claude",
    supporter: "free",
    verification: "unverified",
    input: 4_657_915,
    output: 12_839_513,
    cacheCreate: 152_629_397,
    cacheRead: 2_575_983_107,
    signa: 73.0,
    comp: 0.734,
    pc: 70,
    ct: 26,
  ...
  {
    codename: "static seed · 90d ✱mem",
    realHandle: "OWNER 90d (WITH claude-mem — inflated)",
    domain: "claude",
    supporter: "free",
    verification: "unverified",
    input: 4_709_166,
    output: 15_598_921,
    cacheCreate: 176_566_528,
    cacheRead: 3_282_304_883,
    signa: 80.0,
    comp: 0.768,
    pc: 74,
    ct: 29,
  ...
  {
    codename: "static seed · all ✱mem",
    realHandle: "OWNER all-time (WITH claude-mem — inflated)",
    domain: "claude",
    supporter: "free",
    verification: "unverified",
    input: 4_709_166,
  ...
  {
    codename: "static seed · 7d",
    realHandle: "OWNER 7d (CLEAN — observer stripped)",
    domain: "claude",
    supporter: "free",
    verification: "unverified",
    input: 3_378_021,
    output: 4_019_626,
    cacheCreate: 49_108_106,
    cacheRead: 1_034_353_553,
    signa: 50.0,
    comp: 0.543,
    pc: 55,
    ct: 18,
  ...
  {
    codename: "static seed · 30d",
    realHandle: "OWNER 30d (CLEAN — observer stripped)",
    domain: "claude",
    supporter: "free",
    verification: "unverified",
    input: 4_601_100,
    output: 9_375_735,
    cacheCreate: 109_089_285,
    cacheRead: 2_317_643_032,
    signa: 67.0,
    comp: 0.671,
    pc: 66,
    ct: 24,
  ...
  {
    codename: "static seed · 90d",
    realHandle: "OWNER 90d (CLEAN — observer stripped)",
    domain: "claude",
    supporter: "free",
    verification: "unverified",
    input: 4_652_351,
    output: 12_135_143,
    cacheCreate: 133_026_416,
    cacheRead: 3_023_964_808,
    signa: 75.0,
    comp: 0.722,
    pc: 71,
    ct: 27,
  ...
  {
    codename: "static seed · all",
    realHandle: "OWNER all-time (CLEAN — observer stripped)",
    domain: "claude",
    supporter: "free",
    verification: "unverified",
    input: 4_652_351,
...
export const MOCK_LEADERBOARD: LeaderboardRow[] = (() => {
  ...
  rows.sort(
    (a, b) =>
      (b.snapshot.cascade?.yield_ ?? 0) - (a.snapshot.cascade?.yield_ ?? 0),
  );
  const n = rows.length;
  rows.forEach((r, i) => {
    r.global_rank = i + 1;
...
export const MOCK_OPERATORS: Operator[] = MOCK_LEADERBOARD.map(
  (r) => r.operator,
);
...
export const MOCK_HALL: HallRecord[] = [
  {
    reward_id: "RW.28",
    title: "Highest Compression Ever",
  ...
  {
    reward_id: "RW.30",
    title: "Most Cross-Thread Continuity",
  ...
  {
    reward_id: "RW.31",
    title: "Longest Transmitter Streak",
    operator_codename: "TransVaultOrigin",
    value: "35 days",
    date: "2026-05-19",
    isPlaceholder: true,
  ...
  {
    reward_id: "RW.32",
    title: "Largest 24h Rank Climb",
    operator_codename: "SignalFledgling",
    value: "+5",
    date: "2026-05-18",
    isPlaceholder: true,
  },
  {
    reward_id: "RW.33",
    title: "First Verified Transmitter",
    operator_codename: "TransVaultOrigin",
    value: "claude region",
    date: "2026-05-14",
    isPlaceholder: true,
...
export const MOCK_CLASS_DISTRIBUTION: ClassDistributionRow[] = (() => {
  ...
  for (const row of MOCK_LEADERBOARD) {
    counts.set(
      row.snapshot.class_tier,
      (counts.get(row.snapshot.class_tier) ?? 0) + 1,
    );
  }
