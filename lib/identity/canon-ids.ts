...
export const TOKEN_METRICS: Record<string, TokenMetricDef> = {
  "Y.01": {
    ...
    ticker: "Υ",
    name: "Υ Yield",
    formula: "(T.03 / T.02) × (T.01 / T.02) — leverage × velocity (headline)",
    era: "token",
  },
  "Y.02": {
    id: "Y.02",
    ticker: "SNR",
    name: "SNR",
    formula: "T.01 / (T.01 + T.02) — output share of fresh traffic",
    era: "token",
  },
  "Y.03": {
    id: "Y.03",
    ticker: "LEV",
    name: "Leverage",
    formula: "T.03 / T.02 — cache reuse per fresh input",
    era: "token",
  },
  "Y.04": {
    id: "Y.04",
    ticker: "VEL",
    name: "Velocity",
    formula: "T.01 / T.02 — output per fresh input",
    era: "token",
  },
  "Y.05": {
    id: "Y.05",
    ...
    name: "10xDEV",
    formula:
      "log10(transmission × commitment × reuse); null if any factor is 0",
    era: "token",
  },
  "Y.06": {
    id: "Y.06",
    ticker: "SCALE",
    name: "Scale V",
    formula: "log10(T.05 total tokens) — raw operator scale",
    era: "token",
  },
  "Y.07": {
    id: "Y.07",
    ticker: "$/1M",
    name: "Cost per 1M",
    formula: "blended USD per 1,000,000 tokens — efficiency at the wallet",
    era: "token",
  },
  "Y.08": {
    id: "Y.08",
    ticker: "EFF",
    name: "Efficiency",
    formula: "((T.03 + T.04 + T.01) / T.02) / 4.0 — vs the AA baseline",
    era: "token",
  },
  "Y.09": {
    id: "Y.09",
...
export const PLATFORMS: Record<string, PlatformDef> = {
  "P.01": {
    ...
    label: "Claude",
    domain: "claude",
    hex: colors.platform.Claude,
  },
  "P.02": {
    id: "P.02",
    label: "ChatGPT",
    domain: "chatgpt",
    hex: colors.platform.ChatGPT,
  },
  "P.03": {
    id: "P.03",
    label: "Gemini",
    domain: "gemini",
    hex: colors.platform.Gemini,
  },
...
export const BADGES: Record<string, BadgeDef> = {
  ...
  "BG.06": {
    ...
    rarity: "Epic",
    criteria:
      "Compression ≥ 0.85 sustained through MV in top 10% (busy AND clean).",
    glyph: "⚒",
  },
  "BG.07": {
    id: "BG.07",
  ...
  "BG.13": {
    ...
    rarity: "Legendary",
    criteria:
      "First-ever Transmitter-class assignment in their platform region.",
    glyph: "◈⃝",
  },
  "BG.14": {
    id: "BG.14",
...
export const REWARDS: Record<string, RewardDef> = {
  ...
  "RW.01": {
    ...
    source: "class",
    sourceRef: "K.01",
    reward: "Featured carousel placement (home page).",
  },
  "RW.02": {
    id: "RW.02",
    source: "class",
    sourceRef: "K.01",
    reward: "Verified badge frame on profile.",
  },
  "RW.03": {
    id: "RW.03",
    source: "class",
    sourceRef: "K.01",
    reward: "Priority audit queue access.",
  },
  "RW.04": {
    id: "RW.04",
    source: "class",
    sourceRef: "K.02",
    reward: "Profile glyph upgrade.",
  },
  "RW.05": {
    id: "RW.05",
    source: "class",
    sourceRef: "K.02",
    reward: "Trend chart extended history (365d vs default 90d).",
  },
  "RW.06": {
    id: "RW.06",
    source: "class",
    sourceRef: "K.03",
    reward: "Per-metric historical drilldown unlocked.",
  },
  "RW.07": {
    id: "RW.07",
    source: "class",
    sourceRef: "K.04",
    reward: "Compare engine — vs class average.",
  },
  "RW.08": {
    id: "RW.08",
    source: "class",
    sourceRef: "K.05",
    reward: "Standard profile features (baseline).",
  },
  "RW.09": {
    id: "RW.09",
    source: "class",
    sourceRef: "K.06",
    reward: "Public profile + leaderboard inclusion.",
  },
  // Badge rewards
  "RW.10": {
    id: "RW.10",
    source: "badge",
    sourceRef: "BG.01",
    reward: "Permanent crown glyph on codename.",
  },
  "RW.11": {
    id: "RW.11",
    source: "badge",
    sourceRef: "BG.07",
    reward: '"✓ Audit Verified" pill on profile.',
  },
  "RW.12": {
    id: "RW.12",
    source: "badge",
    sourceRef: "BG.09",
    reward: '"⚡ Largest Rise — [date]" stamp.',
  },
  "RW.13": {
    id: "RW.13",
    source: "badge",
    sourceRef: "BG.12",
    reward: "Hall of Signal nomination (auto).",
  },
  "RW.14": {
    id: "RW.14",
    source: "badge",
    sourceRef: "BG.13",
    reward: "Permanent founder flair (gold border).",
  },
  "RW.15": {
    id: "RW.15",
    source: "badge",
    sourceRef: "BG.16",
    reward: "Profile page reserved spot in Hall page.",
  },
  ...
  "RW.16": {
    ...
    source: "supporter",
    sourceRef: "patron",
    reward: '"🍻 Patron" badge (BG.14).',
  },
  "RW.17": {
    id: "RW.17",
    source: "supporter",
    sourceRef: "patron",
    reward: "Ad-free site (when ads land — currently none).",
  },
  "RW.18": {
    id: "RW.18",
    source: "supporter",
    sourceRef: "patron",
    reward: "Listed in random supporter carousel.",
  },
  "RW.19": {
    id: "RW.19",
    source: "supporter",
    sourceRef: "pro",
    reward: "All Patron rewards.",
  },
  "RW.20": {
    id: "RW.20",
    source: "supporter",
    sourceRef: "pro",
    reward: "sig_army Pro audit (precision-tier scoring).",
  },
  "RW.21": {
    id: "RW.21",
    source: "supporter",
    sourceRef: "pro",
    reward: "Drift Ratio (E.02) computed.",
  },
  "RW.22": {
    id: "RW.22",
    source: "supporter",
    sourceRef: "pro",
    reward: "Score decomposition view.",
  },
  "RW.23": {
    id: "RW.23",
    source: "supporter",
    sourceRef: "pro",
    reward: "Unlimited history depth.",
  },
  "RW.24": {
    id: "RW.24",
    source: "supporter",
    sourceRef: "pro",
    reward: "API access (read + submit).",
  },
  "RW.25": {
    id: "RW.25",
    source: "supporter",
    sourceRef: "circle_sponsor",
    reward: "Circle logo in supporter carousel (header + footer).",
  },
  "RW.26": {
    id: "RW.26",
    source: "supporter",
    sourceRef: "circle_sponsor",
    reward: "All members of circle get Patron-tier rewards.",
  },
  "RW.27": {
    id: "RW.27",
    source: "supporter",
    sourceRef: "circle_sponsor",
    reward: "Recruitment policy flag on circle page.",
  },
  // Hall of Signal rewards
  "RW.28": {
    id: "RW.28",
    source: "hall",
    sourceRef: "highest_compression",
    reward: "Highest Compression Ever — stamped on Hall page.",
  },
  "RW.29": {
    id: "RW.29",
    source: "hall",
    sourceRef: "deepest_session",
    reward: "Deepest Single Session — stamped on Hall page.",
  },
  "RW.30": {
    id: "RW.30",
    source: "hall",
    sourceRef: "most_cross_thread",
    reward: "Most Cross-Thread Continuity — stamped on Hall page.",
  },
  "RW.31": {
    id: "RW.31",
    source: "hall",
    sourceRef: "longest_transmitter_streak",
    reward: "Longest Transmitter Streak — stamped on Hall page.",
  },
  "RW.32": {
    id: "RW.32",
    source: "hall",
    sourceRef: "largest_24h_climb",
    reward: "Largest 24h Rank Climb — stamped on Hall page.",
  },
  "RW.33": {
    id: "RW.33",
    source: "hall",
    sourceRef: "first_verified_transmitter",
    reward: "First Verified Transmitter — stamped on Hall page.",
  },
  "RW.34": {
    id: "RW.34",
    source: "hall",
    sourceRef: "fivefold_hold",
    reward: "Fivefold Hold Recipients — listed on Hall page (multi-recipient).",
  },
};
