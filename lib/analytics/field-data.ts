 ...
 *
 * Also loads public/data/archetypes.json (10 build archetypes from
 * deterministic classification) for the OperatorArchetypes component.
 *
...
import type { FieldAnalysis } from "@/lib/analytics/field-types";
