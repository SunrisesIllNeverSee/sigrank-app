...
export const BOARD_WINDOWS: readonly BoardWindow[] = [
  ...
  { slug: '30d', enum: '30d', label: '30 day', short: '30d', days: 30, buffer: 3 },
  { slug: '90d', enum: '90d', label: '90 day', short: '90d', days: 90, buffer: 3 },
  { slug: 'all', enum: 'all_time', label: 'All time', short: 'All', days: null, buffer: 0 },
]
 ...
 */
export function inWindow(win: BoardWindow, snap: Windowable, ref: number): boolean {
 ...
 */
export function filterToWindow<T extends Windowable>(rows: readonly T[], windowEnum: string): T[] {
