...
type: Reference
title: Operator
description: The individual whose AI-work telemetry is measured. Not necessarily a unique human or legal person. Active.
...
An operator is the individual whose AI-work telemetry is measured in SignalAF. It is not necessarily a legal person, employer, or unique human: one operator can have devices, submissions, and an optional authenticated account link.
